...
location_select = st.sidebar.selectbox('Welk gebied wil je zien?', ('Noord-Holland', 'Zuid-Holland', 'Zeeland', 'Noord-Brabant', 'Utrecht', 'Flevoland', 'Friesland', 'Groningen','Drenthe', 'Overijssel', 'Gelderland', 'Limburg'))
...
# nieuwe kolom aanmaken en filteren
...
#in vorige stap is de datum eerste toelating in date format gezet
...
#Hybride auto's identificeren en plaatsen in nieuwe kolom
...
# spellingsfouten in merken aanpassen
...
#spellingsfouten in modelnaam verbeteren
...
fig11 = go. Figure()
fig11.add_trace(go.Scatter(x=hy_df['Datum_eerste_toelating'], y=hy_df['cumsum'], name='Hybride'))
fig11.add_trace(go.Scatter(x=el_df['Datum_eerste_toelating'], y=el_df['cumsum'], name = "Elektrisch"))
...
fig11.update_layout({'showlegend':True, "legend" :{'title': 'Type auto'}})
